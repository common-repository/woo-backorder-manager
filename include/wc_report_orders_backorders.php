...
class WC_Report_Orders_Backorders extends WC_Report_Stock {
	...
	public function get_items() {
		...
		if ( false === $export_order_statuses) {
			...
			echo __('You have not selected any order statuses for this report.', 'woo-backorder-manager' ) . '<br /><br />';
			echo '<a href="' . admin_url( 'admin.php?page=wc-settings&tab=products&section=backordermanager' ) . '" class="button-secondary">' . __( 'Select order statuses', 'woo-backorder-manager' ) . '</a>';
			echo '</p></div>';
